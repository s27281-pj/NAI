...
Autopilot i modyfikacje: Cyprian i RolandNiniejsze oprogramowanie udostępniane jest bez żadnych gwarancji, z pełnym prawem do użycia, kopiowania, modyfikacji i dystrybucji.
Szczegóły znajdziesz w pliku LICENSE.md.Referencje- Sahin, M., & Kumbasar, T. (2021). Type-2 fuzzy logic-based lunar lander control
